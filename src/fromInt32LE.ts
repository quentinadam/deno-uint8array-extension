 ...
 * @example
 * ```ts
 * import { fromInt32LE, equals } from "@quentinadam/uint8array-extension";
 * import assert from "@quentinadam/assert";
 *
 * assert(equals(fromInt32LE(1000), new Uint8Array([232, 3, 0, 0])));
 * assert(equals(fromInt32LE(-1), new Uint8Array([255, 255, 255, 255])));
 * ```
 *
 ...
 */
export function fromInt32LE(value: number | bigint): Uint8Array<ArrayBuffer> {
