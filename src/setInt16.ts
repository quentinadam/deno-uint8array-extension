/**
 * Writes a signed 16-bit integer to a Uint8Array at the specified offset.
 *
 * @module
 */
 ...
 * @example
 * ```ts
 * import { setInt16, equals } from "@quentinadam/uint8array-extension";
 * import assert from "@quentinadam/assert";
 *
 * const bytes = new Uint8Array(4);
 * setInt16(bytes, 0, 1000, false); // (big-endian)
 * assert(equals(bytes, new Uint8Array([3, 232, 0, 0])));
 * setInt16(bytes, 2, 1000, true); // (little-endian)
 ...
 */
export function setInt16<T extends ArrayBufferLike>(
  target: Uint8Array<T>,
  offset: number,
  value: number | bigint,
